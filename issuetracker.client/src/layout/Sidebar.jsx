...
import { FiPlus, FiCheckSquare, FiFolder, FiChevronDown, FiLogOut, FiSettings, FiBarChart2 } from "react-icons/fi";
...
function Sidebar() {
    ...
    const handleLeaveProject = async (projectId) => {
        ...
        if (result.isConfirmed) {
            const userId = localStorage.getItem('userId');
            const response = await fetch(`/api/projects/${projectId}/leave/${userId}`, {
                method: 'DELETE'
            });
    ...
    return (
        <div className="sidebar">
            ...
            <Link to="/home/my-tasks" className="menu-link">
                <FiCheckSquare /> Мои задачи
            </Link>

            <Link to="/home/statistics" className="menu-link">
