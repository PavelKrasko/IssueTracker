...
{
    /// <inheritdoc />
    public partial class UpdateRoleLength : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Наименование_Роли = table.Column<string>(type: "varchar(50)", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ID_Проекта = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    ID_Администратора_проекта = table.Column<int>(type: "integer", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        column: x => x.ID_Администратора_проекта,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Комментарий_к_задачи = table.Column<string>(type: "varchar(50)", nullable: true),
                    Наименование_Типа_дефекта = table.Column<string>(type: "varchar(20)", nullable: false),
                    Наименование_Роли = table.Column<string>(type: "varchar(50)", nullable: false)
                },
                constraints: table =>
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ID_Вложения = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    Тип_Вложения = table.Column<string>(type: "varchar(255)", nullable: false),
                    Путь_Вложения = table.Column<string>(type: "varchar(255)", nullable: false),
                    ID_Задачи = table.Column<int>(type: "integer", nullable: false)
                },
                constraints: table =>
                {
